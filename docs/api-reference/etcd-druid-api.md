...
| `tolerations` _[Toleration](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.29/#toleration-v1-core) array_ | Tolerations is a list of tolerations that shall be applied to the etcd pods. |  |  |
